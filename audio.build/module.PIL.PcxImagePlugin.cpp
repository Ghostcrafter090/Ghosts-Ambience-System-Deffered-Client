...
static void createModuleCodeObjects(void) {
    ...
    codeobj_f0cdf1219a58aaa124b091074bac6959 = MAKE_CODE_OBJECT(module_filename_obj, 52, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[109], mod_consts[109], mod_consts[123], NULL, 1, 0, 0);
    codeobj_943372f05e5d962788c825e9ac0ff7f0 = MAKE_CODE_OBJECT(module_filename_obj, 142, CO_OPTIMIZED | CO_NEWLOCALS, mod_consts[74], mod_consts[74], mod_consts[124], NULL, 3, 0, 0);
}
...
static PyObject *impl_PIL$PcxImagePlugin$$$function__3__save(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    if (isFrameUnusable(cache_frame_943372f05e5d962788c825e9ac0ff7f0)) {
        ...
        count_allocated_frame_cache_instances += 1;
#endif
        cache_frame_943372f05e5d962788c825e9ac0ff7f0 = MAKE_FUNCTION_FRAME(codeobj_943372f05e5d962788c825e9ac0ff7f0, module_PIL$PcxImagePlugin, sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *)+sizeof(void *));
#if _DEBUG_REFCOUNTS
    } else {
        count_hit_frame_cache_instances += 1;
#endif
    ...
    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(frame_943372f05e5d962788c825e9ac0ff7f0);
