...
static PyObject *impl_matplotlib$stackplot$$$function__1_stackplot(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_end_2:;
    {
...

        {
            ...
            tmp_assign_source_25 = impl___main__$$$function__5_complex_call_helper_pos_keywords_star_dict(dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_args_element_value_14 = impl___main__$$$function__5_complex_call_helper_pos_keywords_star_dict(dir_call_args);
        }
