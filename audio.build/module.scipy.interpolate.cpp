...
static PyCodeObject *codeobj_e659c3fedbd24609966a6b01939475ef;
...
static void createModuleCodeObjects(void) {
    ...
    codeobj_e659c3fedbd24609966a6b01939475ef = MAKE_CODE_OBJECT(module_filename_obj, 191, CO_NEWLOCALS, mod_consts[52], mod_consts[52], mod_consts[53], NULL, 1, 0, 0);
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_e659c3fedbd24609966a6b01939475ef_2;
    NUITKA_MAY_BE_UNUSED char const *type_description_2 = NULL;
    PyObject *exception_keeper_type_2;
    PyObject *exception_keeper_value_2;
    PyTracebackObject *exception_keeper_tb_2;
    NUITKA_MAY_BE_UNUSED int exception_keeper_lineno_2;
    static struct Nuitka_FrameObject *cache_frame_e659c3fedbd24609966a6b01939475ef_2 = NULL;
    ...
    tmp_import_from_1__module = NULL;
    {
        ...
        if (isFrameUnusable(cache_frame_e659c3fedbd24609966a6b01939475ef_2)) {
            Py_XDECREF(cache_frame_e659c3fedbd24609966a6b01939475ef_2);

#if _DEBUG_REFCOUNTS
            if (cache_frame_e659c3fedbd24609966a6b01939475ef_2 == NULL) {
...
#endif
            cache_frame_e659c3fedbd24609966a6b01939475ef_2 = MAKE_FUNCTION_FRAME(codeobj_e659c3fedbd24609966a6b01939475ef, module_scipy$interpolate, sizeof(void *));
#if _DEBUG_REFCOUNTS
        } else {
        ...
        assert(cache_frame_e659c3fedbd24609966a6b01939475ef_2->m_type_description == NULL);
        frame_e659c3fedbd24609966a6b01939475ef_2 = cache_frame_e659c3fedbd24609966a6b01939475ef_2;

        // Push the new frame as the currently active one, and we should be exclusively
        // owning it.
        pushFrameStackCompiledFrame(frame_e659c3fedbd24609966a6b01939475ef_2);
        assert(Py_REFCNT(frame_e659c3fedbd24609966a6b01939475ef_2) == 2);
        ...
        }
        {
            ...
            frame_e659c3fedbd24609966a6b01939475ef_2->m_frame.f_lineno = 191;
        ...
        if (exception_tb == NULL) {
            exception_tb = MAKE_TRACEBACK(frame_e659c3fedbd24609966a6b01939475ef_2, exception_lineno);
        } else if (exception_tb->tb_frame != &frame_e659c3fedbd24609966a6b01939475ef_2->m_frame) {
            exception_tb = ADD_TRACEBACK(exception_tb, frame_e659c3fedbd24609966a6b01939475ef_2, exception_lineno);
        }

        // Attaches locals to frame if any.
        Nuitka_Frame_AttachLocals(
            frame_e659c3fedbd24609966a6b01939475ef_2,
            type_description_2,
            outline_0_var_s
        );
        ...
        if (frame_e659c3fedbd24609966a6b01939475ef_2 == cache_frame_e659c3fedbd24609966a6b01939475ef_2) {
#if _DEBUG_REFCOUNTS
            count_active_frame_cache_instances -= 1;
            count_released_frame_cache_instances += 1;
#endif
            Py_DECREF(cache_frame_e659c3fedbd24609966a6b01939475ef_2);
            cache_frame_e659c3fedbd24609966a6b01939475ef_2 = NULL;
        }

        assertFrameObject(frame_e659c3fedbd24609966a6b01939475ef_2);
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_8)) {
            ...
            tmp_assign_source_18 = IMPORT_NAME(tmp_import_name_from_8, mod_consts[46]);
        }
