...
// Mark the execution in the "__spec__" value.
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_2)) {
            ...
            tmp_assign_source_5 = IMPORT_NAME(tmp_import_name_from_2, mod_consts[160]);
        }
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_3)) {
            ...
            tmp_assign_source_6 = IMPORT_NAME(tmp_import_name_from_3, mod_consts[162]);
        }
    ...
    }
    {
        ...
        if (PyModule_Check(tmp_import_name_from_4)) {
            ...
            tmp_assign_source_7 = IMPORT_NAME(tmp_import_name_from_4, mod_consts[164]);
        }
