...
static PyObject *impl_numpy$lib$histograms$$$function__20_histogramdd(struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    tmp_for_loop_2__for_iterator = NULL;
    {
        ...
        tmp_called_value_13 = LOOKUP_ATTRIBUTE(tmp_expression_value_31, mod_consts[186]);
        if (tmp_called_value_13 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_kw_call_dict_value_0_1 = CALL_METHOD_NO_ARGS(tmp_called_instance_3, mod_consts[187]);
        if (tmp_kw_call_dict_value_0_1 == NULL) {
            assert(ERROR_OCCURRED());
        ...
        frame_76d2646b958d6984b96c927e0043c415->m_frame.f_lineno = 1095;
        {
            ...
            PyObject *kw_values[1] = {tmp_kw_call_dict_value_0_1};
            tmp_assign_source_40 = CALL_FUNCTION_WITH_ARGS2_KWSPLIT(tmp_called_value_14, args, kw_values, mod_consts[188]);
        }
    ...
    }
    {
        ...
        tmp_called_value_15 = LOOKUP_ATTRIBUTE(tmp_expression_value_33, mod_consts[189]);
        if (tmp_called_value_15 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_assign_source_42 = CALL_FUNCTION_WITH_ARGS1_VECTORCALL(tmp_called_value_16, &PyTuple_GET_ITEM(mod_consts[190], 0), mod_consts[191]);
    ...
    }
    {
        ...
        tmp_called_value_18 = LOOKUP_ATTRIBUTE(tmp_expression_value_36, mod_consts[194]);
        if (tmp_called_value_18 == NULL) {
            assert(ERROR_OCCURRED());
    ...
    }
    {
        ...
        tmp_truediv_expr_right_1 = CALL_METHOD_WITH_SINGLE_ARG(tmp_called_instance_5, mod_consts[189], tmp_args_element_value_25);
    ...
    branch_no_15:;
    {
        ...
        tmp_cmp_expr_left_16 = LOOKUP_ATTRIBUTE(tmp_expression_value_39, mod_consts[64]);
